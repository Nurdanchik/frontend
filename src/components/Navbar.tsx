        ...
        {isOpen && (
          <div className="sm:hidden">
            <div className="pt-2 pb-3 space-y-1">
              <Link onClick={toggleMenu} to="/projects" className="block px-3 py-2 rounded-md text-base font-medium text-gray-500 hover:text-gray-900">
                Projects
              </Link>
              <Link onClick={toggleMenu} to="/pricing" className="block px-3 py-2 rounded-md text-base font-medium text-gray-500 hover:text-gray-900">
                Pricing
              </Link>
              <Link onClick={toggleMenu} to="/about" className="block px-3 py-2 rounded-md text-base font-medium text-gray-500 hover:text-gray-900">
                About
              </Link>
            </div>
          </div>
