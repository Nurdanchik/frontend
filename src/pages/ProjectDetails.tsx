...
const projects = [
  ...
  },
  {
    ...
    description: "Create a modern dashboard using React, TailwindCSS, and API integrations.",
    difficulty: "Advanced",
    type: "Frontend",
    duration: "6 weeks",
    participants: 20,
    technologies: ["React", "TailwindCSS", "Recharts", "Axios"],
    requirements: [
    ...
    learningOutcomes: [
      ...
      "Enhance UI with TailwindCSS"
    ]
  },
  {
    id: 3,
    title: "Full-Stack Blog",
    description: "Develop a full-stack blog with user authentication, posts, and comments using MERN stack.",
    difficulty: "Beginner",
    type: "Full-Stack",
    duration: "5 weeks",
    participants: 15,
    ...
    requirements: [
      ...
      "Understanding of front-end and back-end",
